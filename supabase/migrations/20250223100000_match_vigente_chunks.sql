-- RAG: búsqueda por similitud en todos los instrumentos VIGENTES (no solo Constitución).
-- Permite que ingest_manual ingeste cualquier documento y el chat lo use en modo max-reliability.
